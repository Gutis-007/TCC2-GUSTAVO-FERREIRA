...
As \textit{citações indiretas} são feitas com o comando \verb|\textcite{label}|, onde \verb|label| corresponde a um nome dado para chamar a referência no texto. Por exemplo, \textcite{maturana:2003} defende um princípio de lógica...
