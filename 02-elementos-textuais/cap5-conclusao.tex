...
\begin{enumerate}
    ...
    \item \textbf{Avaliação do impacto do nível de experiência}: Observou-se uma diferença de percepção entre os grupos. Iniciantes valorizaram a flexibilidade e a prototipagem rápida do JavaScript (média de $4,29$), enquanto experientes relataram maior produtividade com TypeScript (média de $4,22$, contra $2,93$ dos iniciantes) e maior preferência por seu uso em novos projetos (média de $4,56$). Como a amostra foi pequena e não probabilística, esses resultados não devem ser generalizados sem novas pesquisas.
\end{enumerate}
